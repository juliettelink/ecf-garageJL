  ...
  <section classe="presentation">
    <div class="row flex-lg-row align-items-center g-5 py-5">
      <div class= "presentation col-10 col-sm-8 col-lg-6">
        <img src="assets/images/presentation.jpg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" loading="lazy">
        <div class=" slogan d-flex align-items-center justify-content-center">
            <img src="assets/images/icone-logo-gauche.jpg" class="image-slogan" alt="image icone logo gauche" width="60px">
            <p class="text-center text-slogan"> La confiance est notre priorité ! </p>
            <img src="assets/images/icone-logo-droit.jpg" class="image-slogan" alt="image icone logo droit" width="60px">
        </div>
      </div>
      <div class="col-lg-6">
